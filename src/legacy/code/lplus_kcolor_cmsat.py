...
鐢?SAT (cryptominisat5) 姹備竴涓?k-鐐规煋鑹诧紝骞跺鍑?Gephi 鍙鍖栨枃浠躲€?
...
# 瀹為獙鍚嶅瓧锛岀敤鏉ュ垱寤?results/瀛愭枃浠跺す
EXPERIMENT_NAME = "2025-12-03_C3xC5_k5"

# 鏄惁鎶?CNF 鏂囦欢淇濆瓨鍒?results/runs/legacy_2026/_early_outputs/ 鐩綍锛圱rue/False锛?
WRITE_CNF_FILE = True
CNF_FILENAME = "2025-12-03_C3xC5_k5.cnf"   # 鍙湪 WRITE_CNF_FILE=True 鏃剁敤
...
def build_expanded_line_graph(lengths):
    ...
    L^+(G) 鐨勯《鐐?= G 鐨勮竟锛?
    L^+(G) 鐨勮竟 = L(G) 鐨勮竟 + 鎵€鏈?4-鍦堜腑瀵硅竟涔嬮棿鐨勮竟銆?
...
def main():
    ...
    if colors is not None:
        ...
        print("[INFO] 娌℃湁棰滆壊瑙ｏ紝璺宠繃 Gephi 瀵煎嚭銆?)
